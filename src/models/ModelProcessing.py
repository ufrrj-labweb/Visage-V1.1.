...
class ModelProcessing:
    ...
    def upsample_processing(data,target):
        vect = None
        ...
        return train_data_list,train_target_list,test_data_list,test_target_list
    
    def naivebayes_model_upsampled_alt(train_data_list,train_target_list,test_data_list,test_target_list):
    ...
    def tree_model_upsampled_alt(train_data_list,train_target_list,test_data_list,test_target_list):
    ...
    def forest_model_upsampled_alt(train_data_list,train_target_list,test_data_list,test_target_list):
    ...
    def adaboost_model_upsampled_alt(train_data_list,train_target_list,test_data_list,test_target_list):
